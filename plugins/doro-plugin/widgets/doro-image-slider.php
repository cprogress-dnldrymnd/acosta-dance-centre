	...
	protected function render() {
		...
		<div class="sec-slider">
			<aside id="doro-hero" class="js-fullheight">
			    <div class="flexslider js-fullheight" data-slider-speed="<?php echo esc_attr($settings['slider_speed']); ?>" data-slider-slideshow="<?php echo esc_attr($settings['slider_slideshow']); ?>">
					...
					<ul class="slides">                       
						<?php foreach( $settings['doro_sliders'] as $doro_slide ) { ?>
							...
							<li>
								...
								<a href="<?php echo esc_html($doro_slide['data_url']); ?>" target="<?php echo esc_attr($doro_slide['data_target']); ?>">
								<?php } ;?>
