...
<div class="wrap">
    <h2><?php _e('Bauen Post Order Settings', 'bauen-plugin'); ?></h2>
    <?php if (isset($_GET['msg'])) : ?>
        <div id="message" class="updated below-h2">
            <?php if ($_GET['msg'] == 'update') : ?>
                <p><?php _e('Settings Updated.','bauen-plugin'); ?></p>
            <?php endif; ?>
        </div>
    <?php endif; ?>
    ...
    <form method="post">
        ...
        <div id="restabookorder_select_objects">
            ...
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row"><?php _e('Check to Sort Post Types', 'bauen-plugin') ?></th>
                        <td>
                            <label>
                                ...
                                &nbsp;<?php _e('Check All', 'bauen-plugin') ?></label><br>
                            <?php
        ...
        <div id="restabookorder_select_tags">
            <table class="form-table">
                <tbody>
                    <tr valign="top">
                        <th scope="row"><?php _e('Check to Sort Taxonomies', 'bauen-plugin') ?></th>
                        <td>
                            <label>
                                <div class="epsilon-toggle">
        ...
        <div id="restabookorder_advanved_view">
            <table class="form-table">
                <tbody>
                <tr valign="top">
                    <th scope="row"><?php _e('Check to see advanced view of Post Types ', 'bauen-plugin') ?></th>
                    <td>
                        <label>
                            <div class="epsilon-toggle">
                                <input class="epsilon-toggle__input" type="checkbox"
                            ...
                            <?php echo __('Show advanced view of Post Types','bauen-plugin'); ?>
                        </label><br>
                        <p class="description"><?php _e('NOTICE: This is for advanced users only.','bauen-plugin'); ?></p>
                        <!--@todo : @giucu please look into below description. -->
                        <p class="description"><?php _e('Check to include other custom post types. You will need to update your settings after enabling this option.','bauen-plugin'); ?></p>
        ...
        <p class="submit">
            <input type="submit" class="button-primary" name="restabookorder_submit" value="<?php _e('Update', 'bauen-plugin'); ?>">
        </p>
    ...
    <div class="scpo-reset-order">
        ...
        <div id="restabook_order_reset_select_objects">
            <table class="form-table">
                <tbody>
                <tr valign="top">
                    <th scope="row"><?php _e('Check to reset order of Post Types', 'bauen-plugin') ?></th>
                    <td>
                        <?php
                        foreach ($post_types as $post_type) {
                            if ($post_type->name == 'attachment')
