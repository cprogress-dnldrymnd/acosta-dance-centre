			...
			?>	
                <div class="col-md-4 col-sm-4">  			
					<div class="blog-entry">
						...
						<div class="desc">
						    <h<?php echo esc_attr($settings['title_tag']); ?>><a href="<?php the_permalink();?>"><?php the_title();?></a></h<?php echo esc_attr($settings['title_tag']); ?>>
							<span><?php the_time( get_option( 'date_format' ) ); ?> <?php esc_html_e('|','doro');?> <?php the_category(', ');?></span>											
						    <?php the_excerpt();?>
						</div>	
					</div>			
				</div>			
