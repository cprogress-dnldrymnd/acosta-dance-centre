...
//append load more button
  jQueryloadmorexen.after('<div class="doro-more-wrapper-new text-center  iso-load-more-wrap-gallery" ><a class="doro-more-trigger flex" id="load-more-gallery"> <span class="plus flex-center">&nbsp;</span> </a></div>');
}
...
*/
  ...
  jQuery("#load-more-gallery").click(function() {
    ...
    $(window).on('elementor/frontend/init', function () {
        elementorFrontend.hooks.addAction('frontend/element_ready/doro-gallery.default', gridIsog);
    });
